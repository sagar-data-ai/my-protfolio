  ...
  return (
    <section id="home" className="h-screen flex items-center relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 bg-primary bg-opacity-50 flex justify-between items-center px-6 py-1 border-b border-muted border-opacity-10">
        ...
        <div className="font-mono text-xs text-muted">~SAGAR KUMAR</div>
      </div>
        ...
        >
          ...
          >
            ...
            <div className="nothing-headline font-mono tracking-wide">
              <DottedText text="SAGAR KUMAR" />
            </div>
            <div className="mt-3 text-gradient">Data Science Enthusiast</div>
          </motion.h1>
          ...
          >
            Passionate about uncovering insights through data and building intelligent solutions.
          ...
          >
            <a href="https://github.com/sagar-data-ai" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.linkedin.com/in/sagar-datascience/" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm text-muted hover:text-light transition-colors">
              <svg className="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          >
            ...
            <a href="/resume1.pdf" target="_blank" rel="noopener noreferrer" className="nothing-btn">
              RESUME

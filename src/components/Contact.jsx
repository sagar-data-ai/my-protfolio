      ...
      <div className="container-custom" ref={ref}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          >
            ...
            >
              Looking for data‑driven solutions? Let’s connect and turn ideas into impactful results through collaboration.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:sagark749200@gmail.com" className="text-muted hover:text-light transition-colors">
                    sagark749200@gmail.com
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:+919548035535" className="text-muted hover:text-light transition-colors">
                    +91 9548035535
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a href="https://github.com/sagar-data-ai" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/sagar-datascience" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">

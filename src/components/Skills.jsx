...
const Skills = () => {
  ...
  },
  {
    ...
    skills: [
      ...
      "Seaborn", "Plotly", "BeautifulSoup", "Selenium"
    ]
  },
  {
    name: "Machine Learning & Deep Learning",
    skills: [
      "Scikit-Learn","MLOPS", "Keras",
       "ML Algorithms","PyTorch",
      "NLP","TensorFlow"
    ]
  },
  {
    name: "AI Frameworks & Agentic Systems",
    skills: [
      "LangChain","LangGraph",
      "Vector Databases (Pinecone)", "Agentic AI",
      "MCP Servers", "Prompt Engineering"
    ]
  },
  {
    ...
    skills: [
      ...
      "Tableau","Power BI", "Git / GitHub", "VS Code",
      "AWS"
    ]
  }
];
